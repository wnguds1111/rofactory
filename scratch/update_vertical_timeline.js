...
// Vertical 1-by-1 step timeline layout from Step 1 down to Step 11 with inline considerations
const updatedSection5 = `<!-- ===================== SECTION 5 ===================== -->
            <div class="page-section" id="sec-automation">
                <div class="page-header">
                    ...
                    <h3>5. 공모전 운영 11단계 수직 프로세스 타임라인 및 단계별 고려사항</h3>
                ...
                <div class="page-body">
                    ...
                    <!-- Simple Top-Down Single Column Mermaid Flowchart -->
                    <div class="spec-group" style="background:#ffffff; border:1px solid #e2e8f0; border-radius:16px; padding:24px 28px; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px;">
                            <div style="font-size:15px; font-weight:900; color:#0f172a;">
                                수직 프로세스 이동 플로우차트 (1단계 ~ 11단계)
                            </div>
                            <span style="background:#0f172a; color:#fff; padding:4px 12px; border-radius:12px; font-size:11px; font-weight:800;">Vertical Top-Down Flow</span>
                        </div>
...
flowchart TD
    S1[STEP 01. 일정 사전 세팅 - 어드민 날짜 세팅] --> S2[STEP 02. 발자국 접수 개시 - 이벤트 오픈 및 출품]
    S2 --> S3[STEP 03. 발자국 접수 마감 - 서버 타임스탬프 자동 차단]
    S3 --> S4[STEP 04. S3 자동 보안 검사 - Lambda 헤더 및 3D 규격 검수]
    S4 --> S5[STEP 05. 웹 DB 자동 수신 - 정제 데이터 저장 및 3D 인덱싱]
    S5 --> S6[STEP 06. 투표 노출 - 3D WebGL 그리드 자동 배치]
    S6 --> S7[STEP 07. 유저 인기 투표 - 1일 1회 계정당 투표]
    S7 --> S8[STEP 08. 최종 랭킹 선정 - GM 5개 + 유저 5개 당첨]
    S8 --> S9[STEP 09. 패치 자동 생성 - 클라이언트 패치 및 상점 생성]
    S9 --> S10[STEP 10. 마켓 DB 전달 - 상점 객체 런칭 대기]
    S10 --> S11[STEP 11. 어드민 마켓 개시 - 1-Click 개시 버튼 클릭]
...
if (startIndex !== -1) {
    ...
    console.log('Successfully updated contest_policy.html Section 5 with vertical timeline!');
} else {
