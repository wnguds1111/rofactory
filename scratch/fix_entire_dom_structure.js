...
<body>
    <div class="top-bar">
        <h1>
            <span>RO FACTORY</span>
            <span class="ver">v4.0</span>
            <span style="color: #94a3b8; font-weight: 400; font-size: 13px;">| 시즌제 공모전 상세 기획 명세서</span>
        </h1>
        <div class="top-bar-links">
            <button id="btnEditToggle" onclick="toggleEditMode()" class="btn-nav-link" style="background: rgb(37, 99, 235); color: rgb(255, 255, 255); border-color: rgb(37, 99, 235); cursor: pointer;">✏️ 수정 모드 OFF</button>
            <button id="btnSavePolicy" onclick="savePolicyChanges()" class="btn-nav-link" style="background: rgb(22, 163, 74); color: rgb(255, 255, 255); border-color: rgb(22, 163, 74); cursor: pointer; display: none;">💾 변경사항 저장</button>
            <button id="btnResetPolicy" onclick="resetPolicyContent()" class="btn-nav-link" style="background: rgb(100, 116, 139); color: rgb(255, 255, 255); border-color: rgb(100, 116, 139); cursor: pointer; display: none;">🔄 초기화</button>
    ...
    <div class="layout">
        ...
        <nav class="sidebar">
            ...
            <a href="#sec-automation" class="nav-item active">1. 공모전 운영 10단계 프로세스</a>
            <a href="#sec-ticket" class="nav-item">2. 티켓 지급/소멸 &amp; 결제 체크</a>
            <a href="#sec-risk" class="nav-item">3. 리스크 관리 &amp; 법적 고지</a>

            <div class="nav-divider"></div>
            <div class="sidebar-title">관련 웹 화면 (밝은 약식 레이아웃)</div>
            <a href="contest_event.html" class="nav-item" style="color:#2563eb; background:#eff6ff; border:1px solid #bfdbfe; border-radius:6px; padding:8px 12px; margin-bottom:6px;">공모전 홍보 사이트 (임시 약식)</a>
        ...
        <div class="main">
            ...
            <div class="contest-hero">
                <h2>🏆 RO Factory 시즌제 크리에이터 콘테스트 상세 기획 명세서</h2>
                <p>
                    RO Factory CDN 발자국(Footprint) 트래픽 비용 대응 및 유저 크리에이터 콘텐츠(UGC) 활성화를 위해 진행되는 시즌제 공모전의 세부 운영 정책서 입니다.
                </p>
            </div>
            ...
            <div class="page-section" id="sec-automation">
                ...
                <div class="page-body">
                    ...
                    <div class="alert-box alert-info" style="margin-bottom:24px; background:#f8fafc; border-color:#cbd5e1; color:#1e293b;">
                        ...
                        <div>
                            <strong>RO Factory 공모전 운영 10단계 프로세스 타임라인</strong><br>
                            1단계부터 10단계까지 <strong>위에서 아래로 한 줄씩 순차적으로 내려가는 프로세스 타임라인</strong> 명세입니다.
                        </div>
                    </div>
                    ...
                    <div class="spec-group">
                        <div class="spec-label-row">
                            <div class="spec-label">공모전 운영 10단계 프로세스 세부 명세</div>
                        </div>
            ...
            <div class="page-section" id="sec-ticket">
                <div class="page-header">
                    ...
                    <h3>2. 티켓 지급, 소멸 및 결제 체크 정책 (프리미엄 회원제 대응안)</h3>
                    <div class="section-edit-tools" style="display:none; margin-left:auto; gap:6px;">
                        <button onclick="addTableRow(this)" style="background:#e0f2fe; color:#0369a1; border:1px solid #bae6fd; padding:3px 10px; border-radius:4px; font-size:11.5px; font-weight:700; cursor:pointer;">+ 행 추가</button>
                    </div>
                </div>
            ...
            <div class="page-section" id="sec-risk">
                <div class="page-header">
                    ...
                    <h3>3. 리스크 관리 및 법적 고지 항목 (프리미엄 회원제 일 경우 리스크 처리 방안)</h3>
                    <div class="section-edit-tools" style="display:none; margin-left:auto; gap:6px;">
                        <button onclick="addTableRow(this)" style="background:#e0f2fe; color:#0369a1; border:1px solid #bae6fd; padding:3px 10px; border-radius:4px; font-size:11.5px; font-weight:700; cursor:pointer;">+ 행 추가</button>
                    </div>
                </div>
                <div class="page-body">
                    ...
                    <div class="spec-group">
                        <div class="spec-label-row">
                            <div class="spec-label" style="border-left-color:#dc2626;">프리미엄 회원제 적용 시 리스크 처리 방안 및 법적 고지 명세</div>
                            <div class="section-edit-tools" style="display:none; gap:6px;">
                                <button onclick="addTableRow(this)" style="background:#e0f2fe; color:#0369a1; border:1px solid #bae6fd; padding:3px 10px; border-radius:4px; font-size:11.5px; font-weight:700; cursor:pointer;">+ 행 추가</button>
                            </div>
                        </div>
    ...
    <script>
        ...
        function addTableRow(btnEl) {
            ...
            newRow.innerHTML = \`
                ...
                <td style="text-align:center;"><span class="badge badge-warn" onclick="cycleBadge(this)">사업 확인 필요</span></td>
            \`;
...
console.log('Successfully rebuilt entire contest_policy.html HTML structure with 100% clean nesting!');
