...
function renderBuilderMarks() {
    ...
    window.currentMarks.forEach(m => {
        ...
        const badgeSize = isSubItem ? 'min-width:32px; height:20px; border-radius:5px; font-size:9px;' : 'min-width:26px; height:26px; border-radius:8px; font-size:12px;';
        const badgeBg = isSubItem ? 'background:#ef4444; opacity:0.85;' : 'background:#0ea5e9;';
